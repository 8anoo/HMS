<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="GP1.index" %>
        ...
        <div>
            ...
            <nav class="page-sidebar" data-pages="sidebar">
                ...
                <div class="sidebar-header">
                    ...
                    <span style="font-size: 30px; color: #10b3a4; font-family: initial;">User</span>
                ...
                <div class="sidebar-menu">
                    ...
                    <ul class="menu-items">
                        <li class="m-t-30 " runat="server" id="dashboard">
                            <a href="index.html" class="detailed" title="Dashboard">
                                <span class="title">Dashboard</span>
                                <span class="details">12 New Updates</span>
                            </a>
                            <span class="bg-success icon-thumbnail"><i class="pg-home"></i></span>
                        </li>
                        <li class="" runat="server" id="add_patient">
                            <a href="Add_patient.html" title="Add Patient" class="detailed">
                                <span class="title">Add Patient</span>
                                <span class="details">Some Words...</span>
                            </a>
                            <span class="icon-thumbnail">W</span>
                        </li>
                        <li class="" runat="server" id="add_employee">
                            <a href="Add_Employee.html" title="Add Employee" class="detailed">
                                <span class="title">Add Employee</span>
                                <span class="details">Some Words...</span>
                            </a>
                            <span class="icon-thumbnail"><i class="pg-mail"></i></span>
                        </li>
                        <li class="" runat="server" id="edit_employee_profile">
                            <a href="Edit_Employee_Profile.html" title="Edit Employee Profile"><span class="title">Edit Employee Profile</span></a>
                            <span class="icon-thumbnail"><i class="pg-social"></i></span>
                        </li>
                        <li runat="server" id="edit_patient_profile">
                            <a href="Edit_Patient_Profile.html" title="Edit Patient Profile"><span class="title">Edit Patient Profile</span></a>
                            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
                        </li>
                        <li class="" runat="server" id="reseve_ouside_clinic">
                            <a href="Reseve_OutSide_Clinic.html" title="Reseve OutSide Clinic">
                                <span class="title">Reseve OutSide Clinic</span>
                            </a>
                            <span class="icon-thumbnail"><i class="pg-layouts"></i></span>
                        </li>
                        <li runat="server" id="add_bed">
                            <a href="Add_Bed.html" title="Add Bed"><span class="title">Add Bed</span></a>
                            <span class="icon-thumbnail"><i class="pg-layouts2"></i></span>
                        </li>
                        <li runat="server" id="add_schedule">
                            <a href="Add_Schedule.html" title="Add Schedule"><span class="title">Add Schedule</span></a>
                                                    ...
                                                    <div class="notification-item unread clearfix">
                                                        ...
                                                        <div class="heading open">
                                                            <a href="#" class="text-complete pull-left">
                                                                ...
                                                                <span class="fs-12 m-l-10" >moda</span>
                                                            </a>
                    ...
                    <div class=" pull-right">
                        ...
                        <div class="visible-lg visible-md m-t-10">
                            <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
                                <span class="semi-bold"><span style="color:#3b949d">Welcome </span><a id="name" runat="server"></a></span>
                            </div>
                            <div class="dropdown pull-right">
                                ...
                                <ul class="dropdown-menu profile-dropdown" role="menu">
                                    ...
                                    <li class="bg-master-lighter" >
                                        <a href="#" class="clearfix" runat="server" onserverclick="logout_click">
                                                            ...
                                                            <div class="slide-front tiles slide active">
                                                                <div class="padding-30">
                                                                    <div class="pull-bottom p-b-30 bottom-right bottom-left p-l-30 p-r-30">
                                                                        ...
                                                                        <p>
                                                                            <span class="text-black">Open</span> <span class="m-l-20 hint-text">117.52</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="container-sm-height full-height">
                                                                    <div class="row-sm-height">
                                                                        <div class="col-sm-height padding-25">
                                                                            ...
                                                                            <div class="p-t-10">
                                                                                <p class="hint-text inline">
                                                                                    +0.22% <span class="m-l-20">-2.28</span>
                                                                                </p>
                                                                                <div class="inline">
                                    ...
                                    <div class="widget-15 panel panel-condensed  no-margin no-border widget-loader-circle">
                                        ...
                                        <div class="panel-body no-padding">
                                            <ul class="nav nav-tabs nav-tabs-simple">
                                                <li class="active">
                                                    <a href="#widget-15-tab-1" class="p-t-5">APPL<br/>
                                                        22.23<br/>
                                                        <span class="text-success">+60.223%</span>
                                                    </a>
                                                </li>
                                                <li><a href="#widget-15-tab-2" class="p-t-5">FB<br/>
                                                    45.97<br/>
                                                    <span class="text-danger">-06.56%</span>
                                                </a>
                                                </li>
                                                <li><a href="#widget-15-tab-3" class="p-t-5">GOOG<br/>
                                                    22.23<br/>
                                                    <span class="text-success">+60.223%</span>
                                                </a>
                                                </li>
                            ...
                            <div class="row">
                                <div class="col-lg-4 visible-lg hidden-xlg">
                                    ...
                                    <div class="widget-15-2 panel no-margin no-border widget-loader-circle">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-simple">
                                            <li class="active">
                                                <a href="#widget-15-2-tab-1">APPL<br/>
                                                    22.23<br/>
                                                    <span class="text-success">+60.223%</span>
                                                </a>
                                            </li>
                                            <li><a href="#widget-15-2-tab-2">FB<br/>
                                                45.97<br/>
                                                <span class="text-danger">-06.56%</span>
                                            </a>
                                            </li>
                                            <li><a href="#widget-15-2-tab-3">GOOG<br/>
                                                22.23<br/>
                                                <span class="text-success">+60.223%</span>
                                            </a>
                                            </li>
                                        ...
                                        <div class="p-t-10 p-l-20 p-r-20 p-b-30">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <p class="fs-16 text-black">
                                                        Apple’s Motivation - Innovation distinguishes between A leader and a follower.
                                                ...
                                                <li class="alert-list">
                                                    ...
                                                    <a href="javascript:;" class="p-t-10 p-b-10" data-navigate="view" data-view-port="#chat" data-view-animation="push-parrallax">
                                                        ...
                                                        <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12">
                                                            <span class="text-master link">Jame Smith commented on your status<br/>
                                                            </span>
                                            ...
                                            <ul>
                                                ...
                                                <li class="alert-list">
                                                    ...
                                                    <a href="#" class="p-t-10 p-b-10" data-navigate="view" data-view-port="#chat" data-view-animation="push-parrallax">
                                                        ...
                                                        <p class="p-l-10 col-xs-height col-middle col-xs-12 overflow-ellipsis fs-12">
                                                            <span class="text-master link">12:13AM GTM, 10230, ID:WR174s<br/>
                                                            </span>
