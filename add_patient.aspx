<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="add_patient.aspx.cs" Inherits="GP1.add_patient" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block with-errors"></div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:Button ID="Button1" runat="server" Text="إضافة مريض" style="margin-top: 35px; margin-bottom: 15px; border-color: white; color: #48f5e9; font-size: 20px; background-color: #1d3c39;" class="btn btn-block" OnClick="Button1_Click" ValidationGroup="a"/>
