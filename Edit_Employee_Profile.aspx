<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Edit_Employee_Profile.aspx.cs" Inherits="GP1.Edit_Employee_Profile" %>
                                                ...
                                                <td>
                                                    <table class="auto-style1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label15" runat="server" Text="اسم المستخدم" CssClass="lb"></asp:Label>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div>
                                                                    <asp:Button ValidationGroup="a" ID="btn_save" runat="server" Text="تعديل" CssClass="form-control" OnClick="btn_save_Click1" Style="color: #48f5e9; font-size: 20px; background-color: #1d3c39; float: right; width: 46%; margin-top: 10%; margin-right: 5%" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddl_status" runat="server" class="drpdown">
                                                                    <asp:ListItem Text="أعزب"  Value="1">
                                                                    </asp:ListItem>
